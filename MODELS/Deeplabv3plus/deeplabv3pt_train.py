...
def main():
    ...
    net = Deeplabv3Plus(num_classes=NUM_CLASSES, network_backbone=NET_BACKBONE)
    ...
    for epoch in range(num_epochs):  # loop over the dataset multiple times
       ...
       for idx, batch in enumerate(tqdm(train_dataloader)):
           ...
           if idx % 100 == 0:
               ...
               logging.info('loss : %f, Mean iou: %f, Mean accuracy: %f' % (loss.item(), metrics["mean_iou"], metrics["mean_accuracy"]))
