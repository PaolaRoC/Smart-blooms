...
def trainer_synapse(args, model, snapshot_path, multimask_output, low_res):
    from datasetsSAM.dataset_synapse import Synapse_dataset, RandomGenerator
    ...
    db_train = Synapse_dataset(base_dir=args.root_path, list_dir=args.list_dir, split="train_dataset2",
    ...
    dice_loss = DiceLoss(num_classes+1) ## cambiamos: elinimanos el +1
    if args.warmup:
    ...
    for epoch_num in iterator:
        for i_batch, sampled_batch in enumerate(trainloader):
            ...
            #print(outputs['low_res_logits'].shape)
